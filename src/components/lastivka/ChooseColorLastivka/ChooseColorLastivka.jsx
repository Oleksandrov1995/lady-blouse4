import { productsDataLastivka } from 'data/lastivka/productsDataLastivka';
import './ChooseColorLastivka.css';
import { useEffect, useState } from 'react';

export const ChooseColorLastivka = ({ modalOpen }) => {
  ...
  const handleAddProduct = async (productId, productSize) => {
    ...
    const selectedProduct = productsDataLastivka.find(
  ...
  return (
    <section id="chooseColor" className="product">
      ...
      <ul className="product-list">
        {productsDataLastivka.map(product => (
