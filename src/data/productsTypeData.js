export const productsTypeData = [
  ...
  },
  {
    ...
    todayPrice: 657,
    discount: 30,
    aboutTitle:'Найелегантніша модель нашої лінійки. Може носитися як оверсайз, так і більш приталено, тому завдяки цьому може підійти під будь які типи фігури. Має дві кишені на грудях та розрізи по бокам, для зручності заправлення переду сорочки та створення гарного образу. А опущена лінія плеча додасть до образу легкості та тендітності.',
    aboutText: (<div><p>- Тканина: супер софт; </p>
